...
const Header = () => (
  <div id="Header" className="container text-center">
    ...
    <a href="https://www.facebook.com/omer.mindivanli"><img alt="image" className="rounded mx-auto" width="40px" height="40px" src="https://www.facebook.com/images/fb_icon_325x325.png" /></a>
    <a href="https://twitter.com/following?lang=en"><img alt="image" className="rounded mx-auto" width="40px" height="40px" src="https://upload.wikimedia.org/wikipedia/en/thumb/9/9f/Twitter_bird_logo_2012.svg/1259px-Twitter_bird_logo_2012.svg.png" /></a>
  </div>
);
